...
var apiKey = 'AIzaSyAISG1ooJZXmmiPEHFtc70TseLw4Z9iRQI';
var model;
var logger;
...
GoogleSTT.prototype.init = function(config, parentLogger) {
    ...
    //var credFile = path.join(__dirname,config.stt.google.googleCredentialFile);
    var credFile = config.stt.google.googleCredentialFile;
	console.log('CRED file:====>'+credFile);
    process.env.GOOGLE_APPLICATION_CREDENTIALS = '/home/pi/humix-conversation-module/stt.json';
